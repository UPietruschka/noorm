...
public class ServiceGenerator {
	...
	public void setServiceInterfacePackageName(final String pServiceInterfacePackageName) {
		serviceInterfacePackageName = pServiceInterfacePackageName;
	}
	...
	public void execute() {
		...
		if (serviceInterfacePackageName != null && !serviceInterfacePackageName.isEmpty()) {
			serviceInterfacePackageDir =
					new File(destinationDirectory, serviceInterfacePackageName.replace(".", File.separator));
			if (!serviceInterfacePackageDir.exists()) {
				if (!serviceInterfacePackageDir.mkdirs()) {
					throw new GeneratorException
							("Could not create directory ".concat(serviceInterfacePackageDir.toString()));
				}
			}
		}
		...
		for (final NameBean packageName : packageNames) {
			...
			serviceClassDescriptor.setInterfacePackageName(serviceInterfacePackageName);
